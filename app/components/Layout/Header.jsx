...
class Header extends React.Component {
    ...
    render() {
        ...
        let dashboard = (
                <a style={{flexFlow: "row"}} className={cnames({active: active.indexOf("dashboard") !== -1})}
        ...
        let tradeLink = <a style={{flexFlow: "row"}} className={cnames({active: active.indexOf("market/") !== -1})}
        ...
        if (currentAccount) {
            ...
            if (tradingAccounts.length >= 1) {
                accountsList = tradingAccounts
                    ...
                    .map((name) => {
                        return (
                            <li className={cnames({active: active.indexOf(name) !== -1})}
                                onClick={this._accountClickHandler.bind(this, name)} key={name}>
                                <div style={{paddingTop: 0}} className="table-cell"><AccountImage
                                    style={{position: "relative", top: 4}} size={{height: 20, width: 20}}
                                    account={name}/></div>
                                <div className="table-cell" style={{paddingLeft: 10}}><a
                                    className={"lower-case" + (name === account_display_name ? " current-account" : "")}>{name}</a>
                                </div>
                            </li>
                        );
                    });
                ...
                <div className="grid-block">
                    <ul className="menu-bar">
                        ...
                        {!currentAccount || !!createAccountLink ? null :
                            <li>
                                <Link style={{flexFlow: "row"}} to={`/account/${currentAccount}`}
                                      className={cnames({active: active.indexOf("account/") !== -1 && active.indexOf("/account/") !== -1})}>
                                    <Icon size="1_5x" style={{position: "relative", top: -2, left: -8}}
                                          name="user"/>
                                    <Translate className="column-hide-small" content="header.account"/>
                                </Link>
                            </li>}
                                ...
                                <div className={cnames("dropdown-wrapper", {active: this.state.dropdownActive})}>
                                    <li style={{display: "flex"}}>
                                        <div className="table-cell" onClick={this._toggleLock.bind(this)}>
                                            <Icon className="lock-unlock" style={{margin: "0 0.5rem"}} size="2x"
                                                  name={this.props.locked ? "locked" : "unlocked"}/>
                                        </div>
                                        <div onClick={() => {
                                            this.setState({dropdownActive: !this.state.dropdownActive});
                                        }} className="table-cell" style={{flex: 1}}>
                                            <div style={{
                                                lineHeight: "initial",
                                    ...
                                    <ul className="dropdown header-menu" style={{
                                        ...
                                        <li className={cnames({active: active.indexOf("/assets") !== -1 && active.indexOf("/account/") !== -1})}
                                            ...
                                            <div className="table-cell"><Translate content="explorer.assets.title"/>
                                            </div>
                                        </li>
                                        <li className={cnames({active: active.indexOf("/signedmessages") !== -1})}
                                            ...
                                            <div className="table-cell"><Translate
                                                content="account.signedmessages.menuitem"/></div>
                                        </li>
                                        ...
                                        <li className={cnames({active: active.indexOf("/member-stats") !== -1})}
                                            ...
                                            <div className="table-cell"><Icon size="2x" name="text"/></div>
                                            <div className="table-cell"><Translate content="account.member.stats"/>
                                            </div>
                                        </li>

                                        {isMyAccount ?
                                            <li className={cnames({active: active.indexOf("/vesting") !== -1})}
                                                ...
                                                <div className="table-cell"><Translate content="account.vesting.title"/>
                                                </div>
                                            </li> : null}
                                        ...
                                        <li className={cnames({active: active.indexOf("/whitelist") !== -1})}
                                            ...
                                            <div className="table-cell"><Translate content="account.whitelist.title"/>
                                            </div>
                                        </li>
                                        ...
                                        <li className={cnames({active: active.indexOf("/create-account") !== -1}, "divider")}
                                            onClick={this._onNavigate.bind(this, "/create-account/password")}>
                                            <div className="table-cell"><Icon size="2x" name="user"/></div>
                                            <div className="table-cell"><Translate content="account.create_account"/>
                                            </div>
                                        </li>
                                        ...
                                        <li className={cnames({active: active.indexOf("/accounts") !== -1}, "divider")}
                                            ...
                                            <div className="table-cell"><Translate content="explorer.accounts.title"/>
                                            </div>
                                        </li>

...
class XbtsioWithdrawModal extends React.Component {
    static propTypes = {
                ...
                <div className="grid-container">
                    ...
                    <div className="content-block">
                        ...
                        <label className="left-label">
                            <Translate
                                content="xbtsio.withdraw.minAmount"
                        ...
                        {this.state.minWithdrawError ? (
                            ...
                            >
                                <Translate
                                    content="xbtsio.transfer.errors.minWithdraw"
                                    min_amount={
                    ...
                    {this.props.gateFee ? (
                        ...
                        >
                            ...
                            <label className="left-label">
                                <Translate
                                    content="xbtsio.withdraw.finalNumber"
...
export default BindToChainState(XbtsioWithdrawModal);

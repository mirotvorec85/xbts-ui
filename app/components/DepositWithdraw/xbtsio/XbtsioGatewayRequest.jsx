...
import XbtsioWithdrawModal from "components/DepositWithdraw/xbtsio/XbtsioWithdrawModal";
...
import {xbtsioAPIs} from "api/apiConfig";
import LoadingIndicator from "components/LoadingIndicator";
import QRCode from "qrcode.react";
import PropTypes from "prop-types";

class XbtsioGatewayRequest extends React.Component {
    static propTypes = {
        ...
        min_deposit_amount: PropTypes.any,
    ...
    getWithdrawModalId() {
        ...
        // console.log(this.props.issuer_account.get("name"),this.props.receive_asset.get("symbol"));
    ...
    render() {
        ...
        let issuer = {
            name: "XBTSX",
            support: "support@xbts.io"
        };
        let support_block = (
            <div>
                <label className="left-label">Support</label>
                <div>
                    <Translate content="xbtsio.gateway.support_block" />
                    <br />
                    <br />
                    <span>Mail：</span>
                    <a
                ...
                <div className="Blocktrades__gateway grid-block no-padding no-margin">
                    ...
                    <div className="small-12 medium-7">
                        ...
                        <label className="left-label">
                            <p style={{color: "red"}}>
                                <Translate
                                    content="xbtsio.gateway.deposit_warning"
                                    asset={this.props.deposit_asset}
                                />
                            </p>
                        </label>
                        ...
                        >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            receive_address.address ===
                                                "unknown" ? (
                                                <Translate content="xbtsio.gateway.click_getaddress" />
                                            ) : (
                                                receive_address.address
                                            )}
                                        </td>
                            ...
                            >
                                ...
                                >
                                    <Translate content="xbtsio.gateway.get_deposit_address" />
                                </button>
                            </div>
                            ...
                            <Translate
                                ...
                                minDeposit={this.props.min_deposit_amount}
...
export default BindToChainState(XbtsioGatewayRequest);

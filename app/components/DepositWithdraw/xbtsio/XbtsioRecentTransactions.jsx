...
class XbtsioRecentTransactions extends React.Component {
    static propTypes = {
    ...
    _history(account, action) {
        ...
        if (action === "deposit") {
            url =
                xbtsioAPIs.BASE +
                xbtsioAPIs.DEPOSIT_HISTORY +
                "?account=" +
                account;
        } else {
            url =
                xbtsioAPIs.BASE +
                xbtsioAPIs.WITHDRAW_HISTORY +
                "?account=" +
                account;
        }
...
export default BindToChainState(XbtsioRecentTransactions);

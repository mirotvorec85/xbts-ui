...
class WithdrawModalRuDex extends React.Component {
    ...
    render() {
        ...
        if (!this.state.withdraw_address_check_in_progress && (this.state.withdraw_address && this.state.withdraw_address.length))
        {
            ...
            invalid_address_message = <div className="has-error" style={{paddingTop: 10}}><Translate content="gateway.valid_address" coin_type={this.props.output_wallet_type.toUpperCase()} /></div>;
		    confirmation =
...
export default BindToChainState(WithdrawModalRuDex, {keep_updating:true});
